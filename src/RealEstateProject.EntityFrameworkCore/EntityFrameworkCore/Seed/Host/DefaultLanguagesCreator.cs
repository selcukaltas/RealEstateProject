...
namespace RealEstateProject.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly RealEstateProjectDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = RealEstateProjectConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(RealEstateProjectDbContext context)
        {
            _context = context;
        }
