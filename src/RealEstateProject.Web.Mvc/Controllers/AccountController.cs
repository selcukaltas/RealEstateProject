...
using RealEstateProject.Sessions;
using RealEstateProject.Web.Models.Account;
using RealEstateProject.Web.Views.Shared.Components.TenantChange;

namespace RealEstateProject.Web.Controllers
{
    public class AccountController : RealEstateProjectControllerBase
    {
