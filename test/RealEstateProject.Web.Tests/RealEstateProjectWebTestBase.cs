...
{
    public abstract class RealEstateProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static RealEstateProjectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(RealEstateProjectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<RealEstateProjectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<RealEstateProjectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<RealEstateProjectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<RealEstateProjectDbContext, Task<T>> func)
        {
            T result;
